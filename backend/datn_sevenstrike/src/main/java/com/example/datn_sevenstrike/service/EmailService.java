...
public class EmailService {
    ...
    public void sendOrderConfirmation(HoaDon hoaDon) {
        ...
        try {
            ...
            ClassPathResource logoResource = new ClassPathResource("static/image/1.png");
    ...
    private String buildHtmlInvoice(HoaDon hd, List<HoaDonChiTiet> details) {
        ...
        BigDecimal giamGia = tamTinh.add(phiVanChuyen).subtract(tongSauGiam);
        ...
        sb.append("<td style='font-size:18px;font-weight:bold;color:").append(RED).append(";text-align:right;'>").append(vnFormat.format(tongSauGiam)).append("</td></tr>");
        sb.append("</table>");
        sb.append("</td></tr>");
